                ...
                <div className="post type-post status-publish format-standard has-post-thumbnail hentry category-crazy tag-food tag-inspiration">
                  <div className="single_section_content box blog_large_post_style">
                    ...
                    <div className="post_content">
                      ...
                      <p>A preocupação Ambiental, Social e de Governança (sigla ESG em inglês - Environmental, social and corporate governance), trata-se dos três pilares primordiais a serem considerados em um processo de análise de investimentos. Segundo quem defende a teoria, a incorporação dos três critérios tende a minimizar os riscos dos investimentos e trazer retornos maiores a <a uk-tooltip={openDict('longo prazo')} className={`${artigoStyles.dictLink}`}>longo prazo</a>.</p>
                      
                      <p>
                        <img className="wp-image-4861 alignleft" src={post.images[1]} alt="" width="338" height="423" />Em nosso país, as <a uk-tooltip={openDict('organização')} className={`${artigoStyles.dictLink}`}>organizações</a> ainda não tem suas <a uk-tooltip={openDict('estratégia empresarial')} className={`${artigoStyles.dictLink}`}>estratégias</a> voltadas fortemente para os aspectos de preocupação ambiental, social e de governança. São critérios que, por muitas vezes, são contornados e inseridos nos relatórios da empresa somente para preencher o checklist de empresa sustentável ou algo relacionado a isso.
                      </p>
                      <p>Mas há de se considerar que a temática do ESG vem se alastrando e é algo que, certamente, tende a se disseminar. Atualmente tem gestores de fundos de investimentos que optam por não investir em certos setores, tais como de bebidas, armas e cigarros, mas o buraco é mais embaixo. Os critérios ESG devem fazer parte do dia a dia da empresa, desde a forma como se gerencia, o processo de contratação de <a uk-tooltip={openDict('fornecedor')} className={`${artigoStyles.dictLink}`}>fornecedores</a> até o processo de seleção de pessoal, onde todas as etapas devem se modificar a fim de se enquadrarem ao ESG.</p>
                      <blockquote>
                      ...
                      <p>E você, considera importante que foquemos as nossas análises e investimentos em organizações que se preocupam efetivamente com os critérios do <a uk-tooltip={openDict('esg')} className={`${artigoStyles.dictLink}`}>ESG</a>?</p>
