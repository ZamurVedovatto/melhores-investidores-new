                ...
                <div className="post type-post status-publish format-standard has-post-thumbnail hentry category-crazy tag-food tag-inspiration">
                  <div className="single_section_content box blog_large_post_style">
                    ...
                    <div className="post_content">
                      ...
                      <p>
                        <img className="wp-image-4861 alignleft" src={post.images[1]} alt="" width="258" height="323" />É como se um imóvel fosse dividido em várias partes e você pudesse comprar ou vender cada uma dessas partes. Essas partes são chamadas de cotas.</p>

                      <p>
                        Quando você decide investir em um <a uk-tooltip={openDict('fundos imobiliários/fii')} className={`${artigoStyles.dictLink}`}>FII</a> e compra algumas cotas, você passa a receber um valor em aluguel dos inquilinos desse fundo. Esse valor é proporcional à quantidade de cotas que você comprou e esse aluguel vem todo mês, do mesmo jeito que um imóvel seu que você coloque para alugar.
                      </p>

                      <p>Mas, vale lembra que o investimento em FII é um investimento em <a uk-tooltip={openDict('renda variável')} className={`${artigoStyles.dictLink}`}>renda variável</a> e está exposto às oscilações do mercado. Então comprando ou vendendo cotas de um fundo você vai estar sujeito ao valor de mercado desse fundo naquele dia, que é estabelecido pelas dezenas de pessoas que estão comprando e vendendo as suas cotas naquela hora. Esse valor varia ao longo do dia, dos meses e anos. </p>
