                ...
                <div className="post type-post status-publish format-standard has-post-thumbnail hentry category-crazy tag-food tag-inspiration">
                  <div className="single_section_content box blog_large_post_style">
                    ...
                    <div className="post_content">
                      ...
                      <p>Um outro ponto importante é criar a nossa reserva de emergência antes de começar a investir. Os investimentos em <a uk-tooltip={openDict('renda variável')} className={`${artigoStyles.dictLink}`}>renda variável</a> tem a qualidade de serem interessantes a médio e <a uk-tooltip={openDict('longo prazo')} className={`${artigoStyles.dictLink}`}>longo prazo</a>, devido ao crescimento do valor patrimonial das empresas, crescimento dos lucros, aquisições, entre outros. A bolsa de valores é o maior instrumento de preservação de patrimônio e multiplicação de capital ao longo do tempo, se soubermos escolher as <a uk-tooltip={openDict('ação')} className={`${artigoStyles.dictLink}`}>ações</a> certas.</p>

                      <p>Mas, caso você precise vender parte das suas ações para quitar uma eventual emergência, o seu patrimônio pode estar valendo menos do o que foi investido (investimentos em ações/bolsa de valores são investimentos de renda variável), e isso fará você perder dinheiro. Além do mais, optando pelo <a uk-tooltip={openDict('value investing')} className={`${artigoStyles.dictLink}`}>value investing</a> e/ou <a uk-tooltip={openDict('buy and hold')} className={`${artigoStyles.dictLink}`}>buy and hold</a>, em poucos momentos devemos nos desfazermos de nossas ações, e cobrir uma eventual emergência não é um deles.</p>
